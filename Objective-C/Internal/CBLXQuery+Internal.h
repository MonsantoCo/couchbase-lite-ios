...
@interface CBLXQuery () <CBLJSONCoding>

@property (copy, readonly, nonatomic) CBLQuerySelect* select;

@property (readonly, nonatomic) CBLQueryDataSource* from;

@property (copy, nullable, nonatomic) CBLQueryExpression* where;

@property (copy, nullable, nonatomic) CBLQueryOrderBy* orderBy;
...
@interface CBLQuerySelect () <CBLJSONCoding>
...
@interface CBLQueryExpression () <CBLJSONCoding>
